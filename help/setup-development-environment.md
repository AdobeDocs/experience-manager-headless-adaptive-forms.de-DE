...
Sie benötigen Kenntnisse darüber, wie Sie Anwendungen mit React, Git und Maven erstellen, um adaptive Headless-Formulare zu verwenden.
...
### &#x200B;1. Einrichten von AEM as a Cloud Service SDK {#setup-author-instance}
...
### &#x200B;2. AEM Forms-Archiv (AEM Forms Cloud Service-Add-on) zu AEM SDK hinzufügen {#add-forms-archive}
